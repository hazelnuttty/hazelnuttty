...
I’m passionate about ethical hacking, digital forensics, and reverse engineering. I enjoy exploring how systems operate behind the scenes and simulating real world threats to strengthen security.

I believe good code should be clean, efficient, and secure. My development philosophy centers on scalability, clarity, and long term maintainability.

---
## 🛠️ Tech Stack & Skills  
🌐 **Fullstack**: Node.js (Express), React.js, Flask, TailwindCSS, MongoDB, MySQL  
🛡️ **Cybersecurity**: Penetration Testing, OSINT, Vulnerability Assessment, Exploit Development  
⚙️ **Automation**: Bots, scrapers, API integration, task automation  
🧠 **Others**: Digital Forensics, Reverse Engineering, Shell scripting

---
## 🎯 What I Do  
🔐 Build and secure fullstack applications  
🧪 Perform threat analysis through ethical hacking  
🔍 Hunt digital traces using OSINT techniques  
⚙️ Automate workflows with custom tools  
🚀 Deploy modern web systems with built-in security

---
## 📡 Public APIs  
Use my **free APIs** here:  
[https://zelapioffciall.vercel.app](https://zelapioffciall.vercel.app)

Leave feedback or messages:  
...
> “Build smart. Hack ethically. Stay curious”

---
## 📩 Hire Me  
I help teams and individuals build **secure, scalable systems** with full control and clarity.
...
🛡️ Security isn’t optional. It’s a mindset.  
📬 Contact me via the links above to collaborate.
